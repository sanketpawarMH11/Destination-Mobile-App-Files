...
public class BusDetailActivity extends BaseActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCommentsReference = FirebaseDatabase.getInstance().getReference().child("BusList").child(mPostKey);
	}
	...
	public void onStart() {
		...
		ValueEventListener postListener = new ValueEventListener() {
			...
			public void onCancelled(DatabaseError databaseError) {
				...
				Toast.makeText(BusDetailActivity.this, "Failed to load bus.", Toast.LENGTH_SHORT).show();
			}
		};
	...
	/*private void postComment() {
		...
		FirebaseDatabase.getInstance().getReference().child("Operator").child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
			@Override
			public void onDataChange(DataSnapshot dataSnapshot) {
				...
				Booking comment = new Booking(uid, authorName, commentText);
